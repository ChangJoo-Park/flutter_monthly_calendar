...
void main() {
  testWidgets('MonthlyCalendar', (WidgetTester tester) async {
    ...
    //     Directionality(textDirection: TextDirection.ltr, child: eventCalendar));

    // final eventCalendarFinder = find.byKey(key);

    // expect(eventCalendar.firstWeekday, DateTime.monday);
    // expect(eventCalendar.shortHeader, true);
